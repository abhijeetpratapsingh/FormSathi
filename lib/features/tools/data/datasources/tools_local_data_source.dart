...
class ToolsLocalDataSource {
  ...
  List<ProcessedFileModel> getProcessedFiles() => _box.values.toList(growable: false);

  Future<void> saveProcessedFile(ProcessedFileModel model) => _box.put(model.id, model);
